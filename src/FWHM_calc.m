function  [FWHM, px_width] = FWHM_calc(path_to_file,varargin)
...
% gives the FWHM in metres and in number of pixels.
    ...
    % through binary chop to get the two midpoints for the FWHM calculation
        ...
        [idxs(1),mid_vals(1)]=binary_chop(arr1,max_num/2);
        [idxs(2),mid_vals(2)]=binary_chop(arr2,max_num/2);
